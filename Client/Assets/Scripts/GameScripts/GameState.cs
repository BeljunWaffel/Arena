...
namespace Assets.Scripts.Game_Scripts
{
    public class GameState : MonoBehaviour
    {
        ...
        public static void KillPlayer(string playFabId, bool notifyServer)
        {
            Transform player;
            ...
            {
                Debug.Log($"Could not find player {playFabId}.");
            }
        }

        public static void RespawnPlayer(PlayerInfo playerInfo)
        {
            Transform player;
            if (_players.TryGetValue(playerInfo.PlayFabId, out player))
            {
            ...
            {
                Debug.Log($"Could not find player {playerInfo.PlayFabId}.");
            }
        }
